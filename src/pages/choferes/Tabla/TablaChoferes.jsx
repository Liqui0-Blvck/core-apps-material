          ...
          ? (
            <> 
              ...
              <Tooltip title='Editar'>
                <Ln to={`/app/edicion-conductor/${selected}`}>
...
export default function TablaChoferes({ data, setData, token, loading }) {
                    ...
                    {loading ? (
                      ...
                      <>
                        ...
                        <TableCell className='text-clip overflow-hidden'>
                          <p className='relative left-10'>{row.telefono}</p>
                        </TableCell>
