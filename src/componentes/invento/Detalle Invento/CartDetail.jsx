...
export default function CartDetail({ fecha_creacion, fecha_modificacion, foto, nombre, descripcion, titulo, items }) {
          ...
          <article className='w-full h-full flex gap-2 flex-col-reverse md:flex-row'>
            ...
            <div className='w-full border-[1px] border-gray-300 rounded-md'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-2 w-full h-full'>
                <div className=' rounded h-72 flex flex-col gap-3 p-2 overflow-y-scroll'>
                            ...
                            <>
                              {
                                items.map((item) => {
                                  return (
                                    <Link to={`/app/item/${item.item}`} key={item.id} className='bg-blue-gray-500 hover:bg-blue-gray-300 w-full flex justify-center h-10 items-center rounded-md'>
                                      <h1 className='text-lg text-white font-bold'>{item.item_nombre}</h1>
                                    </Link>
                                  )
                                })
                              }
