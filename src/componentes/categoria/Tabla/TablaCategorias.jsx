  ...
  return (
    ...
    >
      ...
      
      {
        numSelected === 0
        ? (
          <div className='w-52 p-1.5 border border-[#224871] rounded-md bg-[#f1f9fe] hover:bg-[#224871] hover:text-white transition-all ease-in flex items-center justify-center text-[#224871]'>
...

      {
        numSelected <= 1 && numSelected > 0 
          ? (
            <div className='bg-[#224871] hover:bg-[#224871c0] px-5 py-1.5 rounded-md text-white hover:scale-105 transition-all ease-in '>
