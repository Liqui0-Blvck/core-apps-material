...
const ProveedorFormulario = ({ formik, region, comuna, provincia, setRegionID, setProvinciaID }) => {
  ...
  return (
    <form className='grid grid-rows-5 items-center w-full h-96' onSubmit={formik.handleSubmit}>

      <div className='grid grid-cols-8'>
        <div 
            className='border-[2px] h-44 border-dashed border-blue-400 rounded-md p-2 mt-1 col-span-2 row-span-2 flex items-center justify-center cursor-pointer relative z-10'
          ...
          <div className='grid grid-cols-2 items-center col-start-4 col-span-2'>
        ...
        <div className='grid grid-cols-2 items-center col-start-7 col-span-2'>
      ...
      <div className='grid grid-cols-8 row-start-2'>  
      ...
      <div className='grid grid-cols-2 col-start-4 col-span-2 items-center'>
        ...
        <div className='grid grid-cols-2 col-span-2 col-start-7 items-center'>
      ...
      <div className='grid grid-cols-8 row-start-3'>
      ...
      <div className='grid grid-cols-8 row-start-4'>
      ...
      <div className='grid grid-cols-9 row-start-5'>
        <button type='submit' className='col-start-3 col-span-4 p-2 bg-blue-200 rounded-md mt-5 w-full'>Agregar</button>
      </div>
    </form>
  )
}
