...
// export default function TablaEquipos({ data, setData, token, loading }) {
    ...
    >
      ...
      
      {
        numSelected === 0
          ? (
            <Ln to={`/app/registro-equipo`}>
              <div className='w-48 p-1.5 border border-[#224871] rounded-md bg-[#f1f9fe] hover:bg-[#224871] hover:text-white transition-all ease-in flex items-center justify-center text-[#224871]'>
                <span className='font-semibold'>Agregar Equipo</span>
              </div>
            </Ln>
            )
                ...
                return (
                  ...
                  >
                    ...
                    {loading ? (
                      ...
                      <>
                        <TableCell className='text-center text-clip overflow-hidden'>{row.codigo}</TableCell>
                        <TableCell className='text-clip overflow-hidden'>{row.marca}</TableCell>
                        <TableCell className='text-clip overflow-hidden'>{row.procesador}</TableCell>
                        <TableCell className='text-clip overflow-hidden'>{row.licencia}</TableCell>
                        <TableCell className='text-clip overflow-hidden'>{row.ram}</TableCell>
